...
local Window = SciWareLib.CreateLib("TITLE", "Dis")

local Tab = Window:NewTab("TabName")

local Tab2 = Window:NewTab("TabName")

local Section = Tab:NewSection("Section Name")

local Text = Section:NewLabel("Label")

Section:NewButton("Refresh Label",function()
	Text:UpdateLabel("Label Can Be Refresh")
end)
...
Section:NewSlider("SliderText", 500, 0, function(s) -- 500 (MaxValue) | 0 (MinValue)
...
Section:NewKeybind("KeybindText", Enum.KeyCode.F, function()
	print("You just clicked the bind")
end)

Section:NewDropdown("DropdownText", {"Option 1", "Option 2", "Option 3"}, function(currentOption)
	print(currentOption)
end)
